...
Installing "LittleRegistry" can be done either by searching for "LittleRegistry" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
